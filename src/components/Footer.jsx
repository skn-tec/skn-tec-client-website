          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 px-8 py-12 md:px-16">
            ...
            <div>
              ...
              <button
                ...
                disabled={loading}
                className="mt-4 bg-[#34d399] hover:bg-[#10b981] text-white font-bold py-3 px-6 text-sm disabled:opacity-50"
              >
                {loading ? "Sending..." : "Get Updates"}
              </button>

              {status && (
                <p className="text-sm mt-3 text-green-400">{status}</p>
              )}
            </div>
          </div>
